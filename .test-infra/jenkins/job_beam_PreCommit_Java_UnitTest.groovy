...
mavenJob('beam_PreCommit_Java_UnitTest') {
  ...
  goals('-B -e -Prelease,include-runners,jenkins-precommit,direct-runner,dataflow-runner,spark-runner,flink-runner,apex-runner surefire:test@default-test -pl \'!sdks/python\' -DpullRequest=$ghprbPullId')
}
